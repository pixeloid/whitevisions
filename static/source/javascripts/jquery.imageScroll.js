...
(function (root, factory) {
    ...
    $.extend(Plugin.prototype, {
        ...
        init: function () {
            if (this.image) {
                this.$scrollingElement = $('<div class="pre-fixed"><img src="' + this.image + '"/></div>')
            } else {
        ...
        _updatePositions: function () {
            if (this.scrollingState.holderDistanceFromTop <= (this.scrollingState.winHeight) && this.scrollingState.holderDistanceFromTop >= -this.scrollingState.imgHolderHeight) {
                ...
                this.$scrollerHolder.css({visibility: 'hidden'}).removeClass("is-visible");
                this.$scrollingElement.css({visibility: 'hidden'}).removeClass("is-visible");
            }
